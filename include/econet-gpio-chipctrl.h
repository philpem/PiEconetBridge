...
#define C2_READ (ECONET_GPIO_C2_PSE | ECONET_GPIO_C2_CLR_RX_STATUS | ECONET_GPIO_C2_CLR_TX_STATUS | ECONET_GPIO_C2_FLAGIDLE | ((econet_data && econet_data->twobytemode) ? ECONET_GPIO_C2_2BYTES : 0))
#define C3_READ 0x00
...
#define C2_WRITE_INIT1 (ECONET_GPIO_C2_CLR_RX_STATUS | ECONET_GPIO_C2_CLR_TX_STATUS | ECONET_GPIO_C2_PSE | ECONET_GPIO_C2_FLAGIDLE | ((econet_data && econet_data->twobytemode) ? ECONET_GPIO_C2_2BYTES : 0))
...
#define C2_WRITE_INIT2 (ECONET_GPIO_C2_PSE | ECONET_GPIO_C2_FLAGIDLE | ECONET_GPIO_C2_CLR_RX_STATUS | ECONET_GPIO_C2_CLR_TX_STATUS | ECONET_GPIO_C2_RTS | ((econet_data && econet_data->twobytemode) ? ECONET_GPIO_C2_2BYTES : 0))

/* End of frame on transmit */
#define C2_WRITE_EOF (ECONET_GPIO_C2_CLR_RX_STATUS | ECONET_GPIO_C2_TXLAST | ECONET_GPIO_C2_FC | ECONET_GPIO_C2_FLAGIDLE | ECONET_GPIO_C2_PSE | ((econet_data && econet_data->twobytemode) ? ECONET_GPIO_C2_2BYTES : 0))
